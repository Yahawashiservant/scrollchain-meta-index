    ...
    return (<Card>
      ...
      <CardContent className="space-y-4">
        {resources.map((resource, index) => {
            ...
            return (<Button key={index} variant="outline" className="w-full h-auto p-4 justify-start" asChild>
              <Link href={resource.url} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3">
